...
COPY --from=builder /usr/src/projects/iceberg-webserver/file1 /usr/src/projects/iceberg-webserver/file1
COPY --from=builder /usr/src/projects/iceberg-webserver/file2 /usr/src/projects/iceberg-webserver/file2
COPY --from=builder /usr/src/projects/iceberg-webserver/file2 /usr/src/projects/iceberg-webserver/file2
